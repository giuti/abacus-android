...
public class Inicio extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new DrawerItem(tagTitles[0],R.drawable.primera));
        items.add(new DrawerItem(tagTitles[1],R.drawable.segunda));
        //items.add(new DrawerItem(tagTitles[2],R.drawable.baloncesto));
        //items.add(new DrawerItem(tagTitles[3],R.drawable.f1));

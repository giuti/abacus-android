...
public class LigaEsp1Clas extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liga_esp1_clas);
        ...
        //for(int i=0; i<20; i++) {Log.e("TEST", "listaEquiposA: " + listaEquipos.get(i).getNombre());}
        ...
        //recorrer la lista de equipos e ir añadiendo su pos al objeto

        lista = (ListView) findViewById(R.id.ListViewClasificacion);
    ...
    public void calculateClassification(){
        ...
        /*
        Criterios de desempate entre más de dos clubes:
            - Por la mayor puntuación de la que a cada uno corresponda a tenor de los resultados obtenidos entre ellos,
                como si los demás no hubieran participado
            - Por la mayor diferencia de goles a favor y en contra, considerando únicamente,
                los partidos jugados entre sí por los clubes empatados
            - Por la mayor diferencia de goles obtenidos y recibidos, teniendo en cuenta todos los encuentros del campeonato;
                y, siendo aquella idéntica, en favor del club que hubiese marcado más
        */
        for(int i=0; i<17; i++){
            if(listaEquipos.get(i).getPts() == listaEquipos.get(i+3).getPts()){
                Log.e("TEST","Cuádruple empate");
                ...
                }else if((pts1==pts2)&&(pts2==pts3)&&(pts3!=pts4)){
                ...
                }else if((pts2==pts3)&&(pts3==pts4)&&(pts1!=pts2)){
        ...
        for(int i=0; i<18; i++){
            if(listaEquipos.get(i).getPts() == listaEquipos.get(i+2).getPts()){
                ...
                Log.e("TEST","i___ "+i);
                Log.e("TEST","pts1: "+pts1);
                Log.e("TEST","pts2: "+pts2);
                Log.e("TEST","pts3: "+pts3);
                Log.e("TEST","dif1: "+dif1);
                Log.e("TEST","dif2: "+dif2);
                Log.e("TEST","dif3: "+dif3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // getMenuInflater().inflate(R.menu.menu_liga_esp1_clas, menu);
        return true;
    }
